...
# CUDA_VISIBLE_DEVICES=2 python gpt_tuning.py --output_dir mi_tuned_keyword --num_train_epochs 15 --keyword
CUDA_VISIBLE_DEVICES=2 python gpt_sample.py --model_dir mi_tuned_keyword --output_dir mi_tuned_keyword --keyword
