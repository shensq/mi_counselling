...
# mkdir -p ../../models/mi_tuned_5epo
# CUDA_VISIBLE_DEVICES=2 python gpt_tuning.py --output_dir mi_tuned_5epo --num_train_epochs 5
# CUDA_VISIBLE_DEVICES=2 python gpt_sample.py --model_dir mi_tuned_5epo --output_dir mi_tuned_5epo
